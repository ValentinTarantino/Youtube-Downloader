...
app.get("/video-info", async (req, res) => {
    console.log(`[API-INFO] Request received for /video-info with URL: ${req.query.url}`); // Log de inicio de ruta
...
app.get("/download", async (req, res) => {
    console.log(`[API-DOWNLOAD] Request received for /download (Format: ${req.query.format}, Title: ${req.query.title})`); // Log de inicio de ruta
